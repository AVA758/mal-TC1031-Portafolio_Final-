...
void Heap<T>::add(T val) {
	...
	PriorityQueue<T> objpu;
	objpu.push(val);
}

// =================================================================
// TO DO PRIORITY QUEUE:  POP()
...
// =================================================================
// TO DO PRIORITY QUEUE:  TOP()
// 
// Return the first element of the heap.
//
// =================================================================
template <class T>
uint Heap<T>::top() const {
PriorityQueue<T>::top();
}
