...
public:
	...
	virtual std::vector<Vertex> loadGraph() const = 0;
...
public:
	...
	std::vector<Vertex> loadGraph() const;
...
/***********************************************************/
template <class Vertex>
std::vector<Vertex> UMatrixGraph<Vertex>::loadGraph() const {
...
/***********************************************************/
template <class Vertex>
std::vector<Vertex> UListGraph<Vertex>::loadGraph() const {
